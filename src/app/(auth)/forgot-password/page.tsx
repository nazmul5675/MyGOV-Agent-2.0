...
export default function ForgotPasswordPage() {
  return (
    <AuthShell
      ...
      description="Request a secure Firebase password reset email and get back into your citizen or admin workspace quickly."
      sideContent={
        <>
          ...
          <ul className="mt-4 space-y-3 text-sm leading-7 text-primary-foreground/80">
            <li>Password reset is handled by Firebase Auth</li>
